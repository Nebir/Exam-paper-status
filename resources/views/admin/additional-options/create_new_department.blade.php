...
@section('content')
    <div class="table-wrapper">
        <h1 class="text-center" style="margin-bottom: 50px;">New Department Entry</h1>
        <form class="" method="post" action="{{ action('AdminController@addNewDepartment') }}">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-12 col-md-6 mx-auto">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Name of the department" required>
                    </div>
